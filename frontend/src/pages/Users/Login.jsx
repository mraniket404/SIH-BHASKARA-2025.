    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900">EHV Digital Twin</span>
          </div>
        </div>
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          EHV 400/220 kV Substation Monitoring System
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  placeholder="operator@substation.com"
                />
              </div>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-3 grid grid-cols-2 gap-3">
              <div className="text-center p-2 bg-gray-100 rounded text-sm">
                ...
                <div className="text-gray-500">pass: operator123</div>
              </div>
              <div className="text-center p-2 bg-gray-100 rounded text-sm">
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <span>EHV Digital Twin v1.0 • 400/220 kV Substation Monitoring</span>
        </div>
      </div>
    </div>
  )
